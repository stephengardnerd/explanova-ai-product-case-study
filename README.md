...
![Version](https://img.shields.io/badge/version-v3.40.0-4f46e5?style=for-the-badge)
...
Every shipped change is tagged, every deploy names its Cloud Run revision, and every entry in the changelog explains the *why*, not just the *what*. The full progression from `v1.0.0` to `v3.40.0` (177 tags) is the artifact of disciplined release engineering on a one-person team.
